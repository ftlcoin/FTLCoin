...
unsigned int nTargetSpacing = 5 * 30; // 150 seconds
unsigned int nStakeMinAge = 60 * 60 * 24 * 365 * 1000; // pos disabled min stake age 1000 years but really rejected all stake coins 
...
const string strMessageMagic = "FTLCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	nSubsidy >>=  pindexBest->nHeight / 840960;
...
const int DAILY_BLOCKCOUNT =  576;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FTLCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "FTLCoin goes mainstream: Circle's payments make cryptocurrencies easy.";
        CTransaction txNew;
        txNew.nTime = 1418046395;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe3aca842fe411bef0583ec6524491813c0abce96538db609b93f29aee5fd2668"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa2, 0xa6, 0xa1, 0xa4 };
